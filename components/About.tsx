...
export default function About() {
  return (
    <section id="about" style={{ background: "var(--dark)", padding: "120px 0" }}>
      <div style={{ maxWidth: "1200px", margin: "0 auto", padding: "0 48px" }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "80px", alignItems: "center" }}>
          ...
          <div className="reveal">
            <h2 style={{ fontFamily: "'Bebas Neue', cursive", fontSize: "clamp(3rem, 5vw, 4.5rem)", lineHeight: 1, marginBottom: "28px" }}>
              <span style={{ color: "#fff" }}>An Independent</span>
              <br />
              <span style={{ color: "var(--gold)" }}>Sales Organization</span>
              <br />
          ...
          {/* Right — visual grid */}
          <div className="reveal reveal-delay-2" style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "2px" }}>
            {[
